...
def load_data(data, frames, batch_size, Height, Width, Channel, folder, folder_I, I_QP):

    for b in range(batch_size):

        path = folder[np.random.randint(len(folder))] + '/'
        path_I = path.replace('/home/ubuntu/user_space/data/vimeo_septuplet/sequences', '/home/ubuntu/user_space/I-frames', )
        ...
        for f in range(frames):
            ...
            if f == 0:
                img = misc.imread(path_I + 'im1_bpg444_QP' + str(I_QP) + '.png')
